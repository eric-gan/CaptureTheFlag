...
public class TETile implements Serializable {
     ...
     *
     * @param character       Character displayed on the screen.
     * @param textColor       Color of the character itself.
     * @param backgroundColor Color drawn behind the character.
     * @param description     Description of the tile, shown in the GUI on hovering over the tile.
     * @param filepath        Full path to image to be used for this tile. Must be size (16x16)
     */
